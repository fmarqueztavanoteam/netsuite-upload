				...
				<div class="list-header-view-accordion-body-header {{classes}}">
					...
					{{#if rangeFilter}}
						<div class="list-header-view-datepicker-from">
							...
							<div class="list-header-view-datepicker-container-input">
								<input class="list-header-view-accordion-body-input" id="from" name="from" type="date" autocomplete="off" data-format="yyyy-mm-dd" data-start-date="{{rangeFilterFromMin}}" data-end-date="{{rangeFilterFromMax}}" value="{{selectedRangeFrom}}" data-action="range-filter" data-todayhighlight="true" aria-label="{{translate 'Choose from date'}}"/>

								<i class="list-header-view-accordion-body-calendar-icon" aria-hidden="true"></i>
								<a class="list-header-view-accordion-body-clear" data-action="clear-value">
									<i class="list-header-view-accordion-body-clear-icon" aria-hidden="true"></i>
								</a>
							</div>
						</div>
						...
						<div class="list-header-view-datepicker-to">
							...
							<div class="list-header-view-datepicker-container-input">
								<input class="list-header-view-accordion-body-input" id="to" name="to" type="date" autocomplete="off" data-format="yyyy-mm-dd" data-start-date="{{rangeFilterToMin}}" data-end-date="{{rangeFilterToMax}}" value="{{selectedRangeTo}}" data-action="range-filter" data-todayhighlight="true" aria-label="{{translate 'Choose end date'}}"/>
					...
					{{#if sorts}}
						<span class="list-header-view-sorts">
							...
							<button class="list-header-view-accordion-body-button-sort" data-action="toggle-sort" title="{{translate 'Sort'}}" aria-label="{{translate 'Sort'}}">
								<i class="list-header-view-accordion-body-button-sort-up {{sortIconUp}}" aria-hidden="true"></i>
								<i class="list-header-view-accordion-body-button-sort-down {{sortIconDown}}" aria-hidden="true"></i>
							</button>
						</span>
					{{/if}}
