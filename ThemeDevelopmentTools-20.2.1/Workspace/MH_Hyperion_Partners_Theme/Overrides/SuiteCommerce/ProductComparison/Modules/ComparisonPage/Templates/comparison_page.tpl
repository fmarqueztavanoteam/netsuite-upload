<div class="comparison-page-layout-container">
 <div class="comparison-page-title">
  ...
  {{#if showComparisonTable }}
    ...
    <table class="items-table table-for-{{items.length}}-items{{#if isSupportedStickPositioning}} enable-stick{{/if}} productComparisonTable">
      <thead>
      <tr class="item-name-row">
        <td class="specifications-column productComparisonHeader"/>
        {{>itemNameColumns}}
      </tr>
      {{#if isEnabledRating}}
