<div class="cart-detailed">
	...
	<div data-cms-area="tt-landmark_cart_detailed_cms_area_1" data-cms-area-filters="path"></div>
	...
	<div class="cart-detailed-body">
		<section class="{{#if showLines}}cart-detailed-left {{else}}cart-detailed-empty{{/if}}">
			...
			<div class="cart-detailed-quick-order" data-view="Quick.Order"></div>

			<div data-cms-area="tt-landmark_cart_detailed_cms_area_2" data-cms-area-filters="path"></div>
