...
<a class="header-logo" href="{{headerLinkHref}}" data-touchpoint="{{headerLinkTouchPoint}}" data-hashtag="{{headerLinkHashtag}}" title="{{headerLinkTitle}}">
	...
	{{#if logoUrl}}
		...
		{{#if ttStickyHeaderExtension}}
			<img class="tt-ext-sticky-header-logo-image header-logo-image" src="{{getThemeAssetsPathWithDefault ttStickyHeaderExtension.logoUrl 'img/SC_Logo.png'}}" alt="{{siteName}}">
		{{/if}}
