...
<div data-cms-area="tt-landmark_order_wizard_cms_area_1" data-cms-area-filters="page_type"></div>
<div class="order-wizard-step-content-wrapper">
	
	<div class="order-wizard-step-content-main">
		<div data-cms-area="tt-landmark_order_wizard_cms_area_2" data-cms-area-filters="page_type"></div>
		<section id="wizard-step-content"></section>
		<div data-cms-area="tt-landmark_order_wizard_cms_area_3" data-cms-area-filters="page_type"></div>
	</div>


	<div class="order-wizard-step-content-secondary">
		<div data-cms-area="tt-landmark_order_wizard_cms_area_4" data-cms-area-filters="page_type"></div>
