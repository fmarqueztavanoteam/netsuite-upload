{{#if showStockDescription}}
	<p class="product-line-stock-description-msg-description {{stockInfo.stockDescriptionClass}}" title="{{stockInfo.stockDescription}}" aria-label="{{stockInfo.stockDescription}}">
		<i class="product-line-stock-description-icon-description" aria-hidden="true"></i>
