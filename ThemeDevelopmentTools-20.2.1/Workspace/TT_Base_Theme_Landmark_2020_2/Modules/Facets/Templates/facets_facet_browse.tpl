<section class="facets-facet-browse">
	<div data-cms-area="tt-landmark_item_list_banner" data-cms-area-filters="page_type"></div>
	...
	{{#if showResults}}
		<div class="facets-facet-browse-content">
			...
			<div class="facets-facet-browse-facets" data-action="pushable" data-id="product-search-facets">
				...
				<div data-cms-area="tt-landmark_facet_navigation_top" data-cms-area-filters="page_type"></div>
				...
				<div data-cms-area="tt-landmark_facet_navigation_bottom" data-cms-area-filters="page_type"></div>
			</div>
			...
			<div class="facets-facet-browse-results">
				...
				<header class="facets-facet-browse-header">
					...
					{{#unless isCategory}}
					<h1 class="facets-facet-main-title">Shop</h1>
					{{/unless}}

					{{#if showItems}}
					<h2 class="facets-facet-browse-title" data-quantity="{{total}}">
						{{#if keywords}}
				...
				<div data-cms-area="tt-landmark_facets_facet_browse_cms_area_1" data-cms-area-filters="page_type"></div>

				<div id="banner-section-top" class="content-banner banner-section-top" data-cms-area="tt-landmark_item_list_banner_top" data-cms-area-filters="path"></div>
		...
		<div class="facets-facet-browse-cms-area-2" data-cms-area="tt-landmark_facets_facet_browse_cms_area_2" data-cms-area-filters="page_type"></div>

	{{else}}
		<div class="facets-facet-browse-empty-items" data-view="Facets.Items.Empty"></div>
	{{/if}}

	<div id="banner-section-bottom" class="content-banner banner-section-bottom facets-facet-browse-banner-section-bottom" data-cms-area="tt-landmark_item_list_banner_bottom" data-cms-area-filters="page_type"></div>
</section>
