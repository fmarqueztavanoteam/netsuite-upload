...
<div class="facets-faceted-navigation-item-category">
	...
	{{else}}
		<a href="#" class="facets-faceted-navigation-item-category-facet-group-expander {{#if isCollapsed}}collapsed{{/if}}" data-toggle="collapse" data-target="#{{htmlId}}-category-wrapper" data-type="collapse" title="{{translate 'Category'}}">
