	...
	<form class="print-statement-form">
		...
		<div class="print-statement-form-group" data-validation="control-group">
			...
			<div  class="print-statement-form-controls" data-validation="control">
				<input type="date" data-format="yyyy-mm-dd" id="statementDate" name="statementDate" class="print-statement-form-group-input" autocomplete="off" data-todayhighlight="true" aria-label="{{translate 'Statement date'}}"/>
				<i class="print-statement-form-input-icon" aria-hidden="true"></i>
			</div>
		</div>
		...
		<div class="print-statement-form-group" data-validation="control-group">
			...
			<div  class="print-statement-form-controls" data-validation="control">
				<input type="date" data-format="yyyy-mm-dd" id="startDate" name="startDate" class="print-statement-form-group-input" autocomplete="off" data-todayhighlight="true" aria-label="{{translate 'Start date'}} {{translate '(optional)'}}"/>
				<i class="print-statement-form-input-icon" aria-hidden="true"></i>
			</div>
		</div>
